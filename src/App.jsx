            ...
            <div className={styles.header}>
                ...
                >
                    ...
                    <g id='SVGRepo_iconCarrier'>
                        {' '}
                        <path
                            d='M262.593 64.8256C260.038 90.2379 208.837 80.64 247.447 116.033'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M263.855 66.8083C275.157 87.1551 351.063 95.6625 321.012 131.178'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M255.56 97.1004C279.71 92.1802 287.509 126.707 310.734 125.048'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M254.298 119.638C265.609 89.8713 299.669 156.736 311.095 127.031'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M304.424 94.0354C302.701 101.885 304.929 111.793 310.734 117.114'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M258.806 62.1207C226.221 40.554 207.879 80.0882 218.598 109.181C224.118 124.164 239.63 132.321 246.906 145.964C250.227 152.191 249.58 160.548 243.119 163.994'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M169.366 291.636C174.684 301.244 174.126 314.76 171.973 325.523'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M172.842 323.784C184.868 320.568 201.924 315.175 209.625 320.309'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M175.448 324.654C192.64 322.249 207.693 331.148 222.079 337.687'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M174.29 326.102C181.757 330.459 186.349 337.749 191.957 344.059'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M169.077 324.364C162.854 324.301 156.418 325.822 151.41 329.578'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M222.079 290.043C226.916 297.159 229.968 305.448 231.636 313.792'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M233.374 314.082C226.879 315.723 219.433 317.514 213.969 321.612'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M233.664 314.952C244.369 319.742 253.54 325.559 262.048 334.067'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M235.402 312.923C248.645 311.491 260.761 313.102 272.474 318.426'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M234.243 311.475C241.177 304.84 249.709 303.98 258.572 302.207'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                        ...
                        ></path>{' '}
                        <path
                            d='M111.151 167.24C96.1402 128.169 49.9293 193.885 83.3469 193.885C85.7781 193.885 78.1907 193.504 76.1065 194.755C72.8995 196.678 71.6681 201.855 71.472 205.181C70.7071 218.183 72.4215 237.875 82.0024 243.069'
                            stroke='#956c46'
                            stroke-opacity='0.9'
                            stroke-width='16'
                            stroke-linecap='round'
                ...
                <h1 className={styles['todo-label']}>Dodo To-Do</h1>
            </div>
